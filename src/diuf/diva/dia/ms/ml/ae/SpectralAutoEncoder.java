 ...
 */
public class SpectralAutoEncoder extends AutoEncoder implements Serializable {
    ...
    public SpectralAutoEncoder(
        ...
        try {
            ...
            throw new Error(ex.getClass().getName()+": "+ex.getMessage());
        }
    }
    ...
    public float train() {
        ...
        // Clean up -- TODO: check if really necessary
        encoder.clearPreviousError();
        decoder.clearPreviousError();
    ...
    public AutoEncoder clone() {
        ...
        SpectralAutoEncoder autoEncodeer = new SpectralAutoEncoder(
                inputWidth,
                inputHeight,
                inputDepth,
                outputDepth,
